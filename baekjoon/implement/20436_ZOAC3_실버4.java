...
class Main20436 {
    public static void main(String[] args) {
        ...
        curLX = Integer.parseInt(leftKey.substring(2,3));
        curLY = Integer.parseInt(leftKey.substring(4));
        String rightKey = keyMap.get(scanner.next().charAt(0));
        curRX = Integer.parseInt(rightKey.substring(2,3));
        curRY = Integer.parseInt(rightKey.substring(4));
